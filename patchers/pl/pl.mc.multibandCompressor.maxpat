...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 101.0, 735.0, 42.0, 22.0 ],
					"text" : "mc.+~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 268.0, 751.0, 39.0, 22.0 ],
					"text" : "$1 20"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 268.0, 785.0, 34.0, 22.0 ],
					"text" : "line~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 326.0, 751.0, 39.0, 22.0 ],
					"text" : "$1 20"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "bang" ],
					"patching_rect" : [ 326.0, 785.0, 34.0, 22.0 ],
					"text" : "line~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 479.0, 701.0, 67.0, 22.0 ],
					"text" : "* 3.141593"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 478.0, 735.0, 24.0, 22.0 ],
					"text" : "sin"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 478.0, 667.0, 39.0, 22.0 ],
					"text" : "/ 200."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 478.0, 791.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 397.0, 701.0, 67.0, 22.0 ],
					"text" : "* 3.141593"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 396.0, 791.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 396.0, 735.0, 27.0, 22.0 ],
					"text" : "cos"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 396.0, 667.0, 39.0, 22.0 ],
					"text" : "/ 200."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 101.0, 672.0, 40.0, 22.0 ],
					"text" : "mc.*~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 238.0, 667.0, 40.0, 22.0 ],
					"text" : "mc.*~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 396.0, 599.0, 44.0, 48.0 ],
					"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 129.0, 69.0, 22.0 ],
									"text" : "append 0.5"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 164.0, 111.0, 22.0 ],
...
,
					"patching_rect" : [ 1131.0, 246.0, 111.0, 22.0 ],
					"text" : "p"
				}
...
,
					"patching_rect" : [ 1105.0, 158.0, 111.0, 22.0 ],
					"text" : "p"
				}
...
,
					"patching_rect" : [ 976.0, 158.0, 111.0, 22.0 ],
					"text" : "p"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 316.0, 77.0, 44.0, 48.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 226.0, 77.0, 44.0, 48.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 474.331536948680878, 3.208556056022644, 81.0, 212.0 ],
					"saved_attribute_attributes" : 					{
						"bgcolor" : 						{
...
,
					"setminmax" : [ -70.0, 20.0 ],
					"setstyle" : 3,
					"slidercolor" : [ 0.0, 0.966102, 0.918196, 0.5 ]
				}
...
,
					"setminmax" : [ -70.0, 20.0 ],
					"setstyle" : 3,
					"slidercolor" : [ 0.443059, 1.0, 0.050847, 0.5 ]
				}
...
,
					"setminmax" : [ -70.0, 20.0 ],
					"setstyle" : 3,
					"slidercolor" : [ 1.0, 0.339844, 0.1875, 0.5 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 101.0, 802.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 49.732618868350983, 143.315503835678101, 422.459880709648132, 72.192511260509491 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 49.732618868350983, 73.262029945850372, 422.459880709648132, 72.192511260509491 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 49.732618868350983, 3.208556056022644, 422.459880709648132, 72.192511260509491 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 113.0, 103.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 155.0, 166.0, 76.0, 22.0 ],
					"text" : "pl.mc.cross3"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 0 ],
					"midpoints" : [ 164.5, 263.0, 329.5, 263.0 ],
					"order" : 1,
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 0 ],
					"midpoints" : [ 193.0, 257.0, 329.5, 257.0 ],
					"order" : 1,
					"source" : [ "obj-1", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 0 ],
					"midpoints" : [ 221.5, 251.0, 329.5, 251.0 ],
					"order" : 1,
					"source" : [ "obj-1", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 830.0, 144.0, 1114.5, 144.0 ],
					"order" : 0,
					"source" : [ "obj-2", 0 ]
				}
